...
import { courseTypes, levels, statuses } from '../data/data'
import { type Course } from '../data/schema'
import { CourseBulkActions } from './data-table-bulk-actions'
...
export function CoursesTable({ data }: DataTableProps) {
  ...
  const {
    ...
    columnFilters: [
      ...
      { columnId: 'courseType', searchKey: 'courseType', type: 'array' },
    ],
  })
  ...
  return (
    ...
    >
      <DataTableToolbar
        table={table}
        searchPlaceholder='Filter by title, slug or description...'
        filters={[
          {
            columnId: 'status',
            title: 'Status',
